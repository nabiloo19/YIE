        ...
        <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-16 mb-8">
            ...
            <div className="md:col-span-2">
              <a href="#hero" onClick={() => scrollToSection('hero')} className={cn("flex items-center gap-4 mb-8", isRTL ? 'flex-row-reverse' : '')}>
                {/* Desktop Logo */}
                <img 
          ...
          {/* Bottom Section */}
          <div className={cn("border-t border-border/40 pt-8 flex flex-col md:flex-row justify-between items-center gap-6", isRTL ? 'md:flex-row-reverse' : '')}>
            ...
            <button
              onClick={scrollToTop}
              className={cn("hidden md:flex group items-center gap-3 bg-gradient-to-r from-yie-red to-yie-red/80 hover:from-yie-red/90 hover:to-yie-red/70 text-yie-light px-8 py-4 rounded-2xl font-bold transition-all duration-500 transform hover:scale-105 hover:shadow-xl", isRTL ? 'flex-row-reverse' : '')}
            >
